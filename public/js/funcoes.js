    ...
    .then((data) => {
      ...
      if (seletor == 1) {
        ...
        cartasDoUsuario.forEach((registro) => {
          ...
          if(registro.tipo === "Fire") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/a/ad/Fire-attack.png/30px-Fire-attack.png'}
          else if (registro.tipo === "Water") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/1/11/Water-attack.png/30px-Water-attack.png'}
          else if (registro.tipo === "Grass") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/2/2e/Grass-attack.png/30px-Grass-attack.png'}
          else if (registro.tipo === "Lightning") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/0/04/Lightning-attack.png/30px-Lightning-attack.png'}
          else if (registro.tipo === "Fighting") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/4/48/Fighting-attack.png/30px-Fighting-attack.png'}
          else if (registro.tipo === "Colorless") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/1/1d/Colorless-attack.png/30px-Colorless-attack.png'}
          else if (registro.tipo === "Psychic") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/e/ef/Psychic-attack.png/30px-Psychic-attack.png'}
          else if (registro.tipo === "Darkness") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/a/ab/Darkness-attack.png/30px-Darkness-attack.png'}
          else if (registro.tipo === "Metal") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/6/64/Metal-attack.png/30px-Metal-attack.png'}
          else if (registro.tipo === "Fairy") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/4/40/Fairy-attack.png/30px-Fairy-attack.png'}
          else if (registro.tipo === "Dragon") {imagem_tipo.src = 'https://archives.bulbagarden.net/media/upload/thumb/8/8a/Dragon-attack.png/30px-Dragon-attack.png'}
